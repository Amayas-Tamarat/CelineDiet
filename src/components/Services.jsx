...
import Impedance from "../assets/Impedance.png";
    ...
    <div id="Services">
      ...
      >
        <div className="flex flex-col items-center text-center">
          <svg className="h-44 w-44 mb-4" viewBox="0 0 512 512">
            {/* Définir le dégradé */}
            <defs>
              <linearGradient
                id="gradientStroke"
              ...
              >
                <stop
                  offset="0%"
                  style={{ stopColor: "#F2989F", stopOpacity: 1 }}
                />
                <stop
                  offset="100%"
                  style={{ stopColor: "#C2DB9C", stopOpacity: 1 }}
                />
              </linearGradient>
            </defs>

            {/* Appliquer le dégradé aux traits */}
            <path
            ...
            onClick={() =>
              handleOpenModal(
                ...
                <>
                  ...
                  <p className="">
                    En effet, la nutrition s'associe parfaitement avec le sport
                    vous apportant confiance en soi et une motivation
                    supplémentaire pour mener à bien votre parcours de remise en
                    forme.
                  </p>
                  <p className="mb-4">
                ...
                <>
                  ...
                  <p>
                    <span className="font-bold">
                      Tarif 20 euros sans consultation diététique
                    </span>
                    <br></br>
